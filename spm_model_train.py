...
spm.SentencePieceTrainer.train(input="e:\\tamil to eng translation\Machine-Translation\merge_data\eng_Latn-tam_Taml\\train-tam_Taml.txt", model_prefix='spm_ta', vocab_size=10000 )